...
// PRISM
//
// The popover's Voice section (§5.13, §5.15): the live input meter, one
...
struct VoiceSection: View {
    ...
    /// §5.15 — the whole feature, as one picker.
...
/// The always-on microphone meter (§5.15), shared by the popover's Voice
