...
// PRISMTests
//
// The in-memory session history (§5.17): coalescing, the capacity bound,
...
final class SessionLogTests: XCTestCase {
    ...
    func testEveryMenuBarStateHasSomethingToSay() {
        ...
        for state in [MenuBarState.idle, .live, .effects, .replaying, .away,
                      .badConnection, .lagging, .frozen, .muted, .panicked, .error] {
